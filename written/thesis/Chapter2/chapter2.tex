...
\begin{equation} \label{eq:backscatteringMatrix}
  \bm{S} = \begin{bmatrix} \bm{HH} & \bm{HV} \\ \bm{VH} & \bm{VV} \end{bmatrix}
\end{equation} 

Para poder cumplir con el objetivo, el radar que se construye debe cumplir con los requermientos que se muestran en la figura \ref{fig:requirements}
...
\begin{figure}[H]
  ...
  \begin{tabular}[t]{|@{}p{4cm}@{}|}
    \hline
    \textbf{Requermientos L0} \tabularnewline
    \hline
    \tabularnewline

    \begin{enumerate}[label=L0.\arabic*, nosep]
      \req{Matriz de dispersión} \label{en:l0}
  ...
  \begin{tabular}[t]{|@{}p{4cm}@{}|}
    \hline
    \textbf{Requermientos L1} \tabularnewline
    \hline

    \begin{enumerate}[label=L1.\arabic*, nosep]
      \req{Clase de Radar} \label{en:l1_radarType}
      \req{Polarización} \label{en:l1_pol}
      \req{Distancia} \label{en:l1_distance}
      \req{Ganancia} \label{en:l1_gain}
      \req{Fase} \label{en:l1_phase}
    \end{enumerate} \tabularnewline
  ...
  \begin{tabular}[t]{|@{}p{4cm}@{}|}
    \hline
    \textbf{Requermientos L2} \tabularnewline
    \hline

    \begin{enumerate}[label=L2.\arabic*, nosep]
      \req{Frecuencia central} \label{en:l2_f0}
      \req{Ancho de banda} \label{en:l2_bw}
      \req{Modulación} \label{en:l2_mod}
      \req{Ganancia} \label{en:l2_2}
      \req{Fase} \label{en:l2_3}
    \end{enumerate} \tabularnewline
  ...
  \end{tabular}
  \caption{Requermientos de alto medio y bajo nivel de construcción del radar.}
  \label{fig:requirements}
\end{figure}

\begin{description}
  \item[\ref{en:l0}:] El radar debe ser capaz de determinar la matriz de dispersión de cuerpos.
  \item[\ref{en:l1_radarType}:] El radar debe ser del tipo FMCW.
  \item[\ref{en:l1_pol}:] El radar debe ser capaz de transmitir y recibir en ambas polarizaciones, vertical y horizontal.
  \item[\ref{en:l1_distance}:] El radar debe ser capaz de determinar la distancia al cuerpo iluminado.
  \item[\ref{en:l1_gain}:] El radar debe ser capaz de determinar la ganancia del cuerpo iluminado.
  \item[\ref{en:l1_phase}:] El radar debe ser capaz de determinar el desfase del cuerpo iluminado.

  \item[\ref{en:l2_f0}:] La frecuencia central de la señal transmitida debe ser igual a $\SI{1245}{\MHz}$.
  \item[\ref{en:l2_bw}:] El ancho de banda de la señal transmitida debe ser de $\SI{300}{\MHz}$.
  \item[\ref{en:l2_mod}:] La modulación es del tipo diente de sierra.
\end{description}
...
Cuando es continua, el transmisor está continuamente transmitiendo una señal, usualmente sin interrupción, cuando el radar está operando. El receptor también está operando continuamente. Como contraparte, en los radares pulsados, el transmisor emite una secuencia de pulsos de duración finita, separados en tiempos donde el transmisor está "apagado". Cuando esto ocurre, el receptor está encendido de forma tal que la señal del blanco iluminado puede detectarse.
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.7\textwidth}
    \includegraphics[width=8cm]{FMCWambiguity}
    \caption{Señal transmitida y recibida en función del tiempo}
    \label{fig:fmcwAmbiguity}   
  \end{subfigure}

  \begin{subfigure}[b]{0.7\textwidth}
    \includegraphics[width=8cm]{receivedFrequency}
...
Por último, la señal mezclada es filtrada eliminando los componentes de alta frecuencia, asumiendo un filtro ideal y observando que en la ecuación \ref{eq:signalFrequency4} se elimina el coseno correspondiente a la suma de frecuencias, se puede deducir que la potencia de salida es la mitad que la de entrada.
