...
Para cumplir con dicho requerimiento en la imagen siguiente 
El requerimiento de alto nivel es 
...
\begin{figure}
  ...
  \begin{tabular}[t]{|@{}p{4cm}@{}|}
    \hline
    \textbf{Requermientos L0}
    \hline
    \tabularnewline

    \tabitem Matriz de dispersión \tabularnewline
